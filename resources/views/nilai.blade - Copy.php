...
@foreach($data as $key => $n)
                <tr>           	  
                  ...
                  <td>{{$n->nis}}</td>
                  <td><input class="form-control" type="text" name="k4satu[]" value="{{$n->nilai_kelas4_s1}}"></td>
                  <td><input class="form-control" type="text" name="k4dua[]" value="{{$n->nilai_kelas4_s2}}"></td>
                  <td><input class="form-control" type="text" name="k5satu[]" value="{{$n->nilai_kelas5_s1}}"></td>
                  <td><input class="form-control" type="text" name="k5dua[]" value="{{$n->nilai_kelas5_s2}}"></td>
                  <td><input class="form-control" type="text" name="k6satu[]" value="{{$n->nilai_kelas6_s1}}"></td>
                  <td><input class="form-control" type="text" name="uas[]" value="{{$n->uas}}"></td>
                </tr>
@endforeach
                </tbody>
                <tfoot>
