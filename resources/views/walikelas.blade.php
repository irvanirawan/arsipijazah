...
@if(Session::has('wksimpan'))
<div class="alert alert-success alert-dismissible">
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
      <h4><i class="icon fa fa-check"></i> Sukses !</h4>
      {{ Session::get('wksimpan') }}
</div>
@endif
@if(Session::has('wkhapus'))
...
@endif
@if(Session::has('wkupdate'))
<div class="alert alert-info alert-dismissible">
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
      <h4><i class="icon fa fa-check"></i> Info !</h4>
      {{ Session::get('wkupdate') }}
</div>
@endif
...
@foreach($data as $key => $d)
                <tr>
                  ...
                  <td>
                    ...
                    <a href="/guru/delete/{{ $d->idnya }}" class="btn btn-danger btn-xs" onclick="return confirm('Yakin Hapus?')">Hapus</a>
                  </td>
                </tr>
@endforeach
                </tbody>
...
<script>
function edit(id) {
  document.getElementById('judul').innerHTML = "Form Edit Data Guru";
  document.getElementById("myForm").action = "{{route('saveeditwk')}}";
  var a = id;  
  $.ajax({
        url: "/guru/put/"+a,
        type: "get",
