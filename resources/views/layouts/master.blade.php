...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{asset('AdminLTE-2.4.2/dist/css/skins/skin-blue.min.css')}}">
    <!-- DataTables -->
      ...
      <div class="wrapper">
        ...
        <header class="main-header">
          ...
          <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>A</b>rsip</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Arsip</b> Ijazah</span>
          </a>
          <!-- Header Navbar -->
        ...
        <footer class="main-footer">
          ...
          <!-- Default to the left -->
          <strong>&copy; {{date('Y')}} <a href="#">SD Penabur Ilmu</a>.</strong>
        </footer>
        <!-- Control Sidebar -->
